...
const Reviews = () => {
  ...
  return (
    <section ref={sectionRef} className={`bg-neutral-50 transition-all duration-500 ${sectionVisible ? 'py-16 md:py-24' : 'py-2'}`}>
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
              {reviews.map((review, index) => (
                <div
                  key={review.id}
                  className={`animate-fade-in-up ${delayClasses[index % 3]} bg-white border border-stone-200 p-6 md:p-8 hover:border-stone-300 transition-all`}
                >
                  {/* Stars */}
